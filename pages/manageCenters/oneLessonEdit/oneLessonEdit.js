...
Page({
    ...
    formSubmit: function (e) {
        ...
        sendData['id'] = this.data.actNiceId;
        sendData['start_time'] = this.data.startTime;
        sendData['end_time'] = this.data.endTime;
        sendData['pay_status'] = sendData.pay_status ? 1 : 0;
        sendData['description'] = this.data.description;
        sendData['act_image'] = this.data.actImageId
        sendData['status'] = this.data.status ? 1 : 0
        sendData['sort'] = 1;
        sendData['join_info_text'] = this.data.joinInfo;
        sendData['join_info_require'] = this.data.joinInfoId;
        sendData['cover_image'] = this.data.coverImageId;
